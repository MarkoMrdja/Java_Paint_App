...
public class ModRectangle extends JDialog implements ActionListener {
	...
	public ModRectangle() {
		...
		{
			JLabel lblNewLabel_1 = new JLabel("Upper Left Point");
		...
		{
			JLabel lblRadius = new JLabel("Height");
